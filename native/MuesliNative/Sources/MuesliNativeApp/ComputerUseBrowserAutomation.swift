...
enum ComputerUseBrowserAutomation {
    ...
    static func activateTab(
        ...
        if !allowActivation {
            return .needsConfirmation("Quiet tab activation by browser index is not window_id scoped. Use a process/window-scoped click on the tab from the latest screenshot, or switch Computer Use to direct control.")
        }
