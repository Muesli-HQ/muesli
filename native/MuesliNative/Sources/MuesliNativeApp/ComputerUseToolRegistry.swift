...
private extension ComputerUseToolSchemaProperty {
    ...
    static func boolean(_ description: String) -> ComputerUseToolSchemaProperty {
        ComputerUseToolSchemaProperty(type: "boolean", description: description)
    }
