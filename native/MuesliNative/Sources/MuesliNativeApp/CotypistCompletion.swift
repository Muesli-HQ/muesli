...
enum CotypistOutputSanitizer {
    static func sanitize(_ raw: String, for context: FocusedTextContext) -> String? {
        ...
        let rejectionMarkers = [
            ...
            "<suffix>", "</suffix>", "<caret>", "assistant:", "analysis:",
            "reasoning:", "completion:", "continuation:", "here is", "i suggest",
            "the user", "as an ai",
        ]
        guard !rejectionMarkers.contains(where: lower.contains) else { return nil }
